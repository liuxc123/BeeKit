...
protocol BEEAnimation {
    var delay: TimeInterval { get set }
    var duration: TimeInterval { get set }
    var spring: BEEAttributes.Animation.Spring? { get set }
}

// A protocol that describes a range animation
protocol BEERangeAnimation: BEEAnimation {
...
public extension BEEAttributes {
    ...
    struct Animation: Equatable {
        ...
        public struct RangeAnimation: BEERangeAnimation, Equatable {
        ...
        public struct Translate: BEEAnimation, Equatable {
            ...
            public enum AnchorPosition: Equatable {
                ...
                /** Automatic position - the entry shows and exits according to BEEAttributes.Position value. If the position of the entry is top, bottom, the entry's translation anchor is top, bottom - respectively.*/
                case automatic
            }
