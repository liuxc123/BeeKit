...
final public class BEETextField: UIView {

    // MARK: - Properties

    static let totalHeight: CGFloat = 45

    private let content: BEEProperty.TextFieldContent
    ...
    public init(with content: BEEProperty.TextFieldContent) {
    ...
    private func setupImageView() {
        ...
        imageView.set(.width, .height, of: BEETextField.totalHeight)
    ...
    private func setupTextField() {
        ...
        textField.set(.height, of: BEETextField.totalHeight)
