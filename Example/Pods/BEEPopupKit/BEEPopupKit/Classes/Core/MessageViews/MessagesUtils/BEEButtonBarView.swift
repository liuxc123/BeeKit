 ...
 */
final public class BEEButtonBarView: UIView {
    ...
    public init(with buttonBarContent: BEEProperty.ButtonBarContent) {
    ...
    private func setupButtonBarContent() {
        for content in buttonBarContent.content {
            let buttonView = BEEButtonView(content: content)
    ...
    private func setupTopSeperatorView() {
        ...
        topSeparatorView.set(.height, of: 1.0)
    ...
    private func setupSeperatorView(after view: UIView) {
        ...
        midSepView.set(relativeEdge, of: 1.0)
