//
//  BEENotificationMessageView.swift
//  BEEPopupView
//
...
final public class BEENotificationMessageView: BEESimpleMessageView {

    // MARK: Props
    private var auxLabel: UILabel!
    private var auxiliaryContent: BEEProperty.LabelContent!

    private let message: BEENotificationMessage

    // MARK: Setup
    public init(with message: BEENotificationMessage) {
    ...
    private func setupAuxLabel(with content: BEEProperty.LabelContent?) {
    ...
    private func layoutContent(with insets: BEENotificationMessage.Insets) {
