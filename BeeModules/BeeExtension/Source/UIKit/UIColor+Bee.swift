...
public extension Bee where Base: UIColor {
    @discardableResult
...
public extension UIColor {
    ...
    @discardableResult
    func bee_alpha(_ a:CGFloat) -> UIColor {
        return self.withAlphaComponent(a)
    }
    
    @discardableResult
    static func bee_hex(_ hex:String, dark:String? = nil) -> UIColor {
    ...
    var bee_rgba:(CGFloat,CGFloat,CGFloat,CGFloat) {
        var r:CGFloat = 0
        var g:CGFloat = 0
        var b:CGFloat = 0
        var a:CGFloat = 1
    ...
    var bee_alpha:CGFloat {
        return self.bee_rgba.3
    }
}
